...
public class StreamOperations
{
	public static void main(String[] args)
	{
		...
		employees.add(new Employee(12351, "Romit", 200, 98056, 57000.00));
		employees.add(new Employee(12351, "Rohit", 100, 96056, 59000.00));
		employees.add(new Employee(12351, "Amar", 100, 87056, 42000.00));
		employees.add(new Employee(12351, "David", 200, 84056, 62000.00));
		employees.add(new Employee(12351, "Rahim", 300, 81056, 72000.00));
		employees.add(new Employee(12351, "Kaushik", 300, 99056, 46000.00));
		...
		List<String> employeesWithConditions = employees.stream()
				.filter(combined)
				.map(employee -> employee.getName())
				.toList();

		System.out.println("Employees with salaries greater than 50k and code commits greater than 70k: " + employeesWithConditions);
		...
		System.out.println("Department wise 3rd highest salary : " + deptWise3rdHighestSalary);
